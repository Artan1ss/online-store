...
// Define a proper interface for the results object
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    // Explicitly define the results object with the interface
    const results: RepairResults = {
      orderItems: 0,
      orders: 0,
      messages: [] // TypeScript now knows this is string[] because of the interface
    };
